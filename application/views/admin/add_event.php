...
<head>
    ...
    <title>RITAC Admin - Add Event</title>
    <!-- /. HEADER  -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         ...
                         <form id="add_event" method="post" enctype="multipart">
...
<!-- /. FOOTER  -->
    ...
    $(document).ready(function(){
        ...
        $("#add_event").on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo base_url();?>home/submit_event",// url to your upload process file
                    type: "POST",
                    dataType:'json',
