        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo base_url()?>#events">Events</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="<?php echo base_url()?>#facts">Study Abroad</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
           ...
           <div class="social-links">
              <a href="https://www.facebook.com/RITACITSOLUTION/?ref=br_rs" class="facebook" target="_blank"><i class="fa fa-facebook"></i></a>
              <a href="https://plus.google.com/+RITAC" class="google-plus" target="_blank"><i class="fa fa-google-plus"></i></a>
              <a href="https://www.linkedin.com/in/ritac-technolabs-6119b4162/" class="linkedin" target="_blank"><i class="fa fa-linkedin"></i></a>
            </div>
          </div>
