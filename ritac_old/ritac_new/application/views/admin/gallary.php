                                      ...
                                      foreach($gallery as $gal)
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('assets/gallery/');?><?php echo  $image;?>" data-title="<?php echo $gal['description']?>" data-lightbox="events" class="link-preview" title="Preview">
                                                    <img src="<?php echo base_url("assets/gallery/").$image;?>" style="width:50px;height: 50px;" >
                                                </a>
                                                <?php
                                                }
                                                ?>
