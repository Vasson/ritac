...
<head>
    ...
    <link href="<?php echo base_url();?>vendors/css/dropdown.css" rel="stylesheet">
    <script src="<?php echo base_url();?>vendors/js/jquery.min.js"></script>
     <script src="<?php echo base_url();?>vendors/js/dropdown.js"></script>
<style>
/*#aboutus>h2,p,h3
{
   color: #3a2222;
                ...
                <div id="menu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                      ...
                      <!--   <li class="blog"><a href="#blog-wrapper">IT</a></li> -->
                        ...
                        <li class="partner"><a href="#">Partners</a></li>
                        ...
                        <script>
                            ...
                            {
                                // $(".dropdown-content").animate({height: "easein"});
...
<div id="services-wrapper">
    <div id="services">
        <div class="inner-wrapper">
			<div class="container">
				<h2 style="font-size: 30px;">Check out our <span>Services</span></h2>
...
<div id="aboutus-wrapper">
    <div id="aboutus" style="color:  black;">
        <div class="inner-wrapper">
            <div class="row">
                <div class="container">
                    <h2 style="color:  black;font-size: 30px;">Read more <span> About us</span></h2>
                    ...
                    <div class="row contents">
                        ...
                        <div class="col-md-6">
                            <h3 style="color:  black;">Our Skills</h3>
                    ...
                    <div class="row">
                         <div class="col-md-6 col-sm-9 col-xs-12">
                            <div class="row">
                                <span style="font-size: 15px;font-weight: 800; color: #3a2222;">IT ASSOCIATE PARTNERS</span><br><br>
                            </div>
                            <div class="row">
                                <img src="<?php echo base_url();?>vendors/images/clients/thinkpalm.png" style="height: 64px; width: 176px;" alt=""><br>
                            </div>
                             <div class="row">
                                <label style="font-size: 15px;color: #0f3b4c; font-family: Georgia;">THINK PALM TECHNOLOGIES.</label><br><br><br><br>
                            </div>
                             <div class="row">
                                 <img src="<?php echo base_url();?>vendors/images/clients/bell_logo.png" alt=""><br>
                             </div>
                              <div class="row">
                                <label style="font-size: 15px;color: #0f3b4c; font-family: Georgia;">BELL TECHNOLABS.</label>
                            </div>
                                
                            </div>
                        
                              <div class="col-md-6 col-sm-9 col-xs-12">
                                <span style="font-size: 15px;font-weight: 800;color: #3a2222;">EDUCATIONAL ASSOCIATE PARTNERS</span><br>
                                <img src="<?php echo base_url();?>vendors/images/clients/almanarat.png" style="height: 81px; width: 176px;" alt=""><br>
                                <label style="font-size: 15px;color: #0f3b4c; font-family: Georgia;">MANARAT ALMARIFA.</label><br><br><br><br>
                                <img src="<?php echo base_url();?>vendors/images/clients/future.png" alt=""><br>
                                <label style="font-size: 15px;color: #0f3b4c; font-family: Georgia;">FUTURE ABROAD.</label><br><br><br><br>
                                <img src="<?php echo base_url();?>vendors/images/clients/educare_trans.png"  style="width: 250px; height: 150px;"><br><br>
                                <label style="font-size: 15px;color: #0f3b4c; font-family: Georgia;">EDUCARE.</label>
                             </div>
                    ...
                    <br>
                     <div class="connect">
                                ...
                                <div class="social-shares">
                                    <ul>
                                    <li><a href="https://www.linkedin.com/in/ritac-technolabs-6119b4162/"><i class="fa fa-linkedin" style="
    background-color: #36c4f4;"></i></a></li>
                                        <li><a href="https://www.facebook.com/RITACITSOLUTION/?ref=br_rs"><i class="fa fa-facebook"></i></a></li>

                                        <li><a href="https://plus.google.com/+RITAC"><i class="fa fa-google-plus"></i></a></li>

                                       <!--  <li><a href="skype:RITAC TECHNOLAB?call"><i class="fa fa-skype"></i></a></li> -->
                                    </ul>
                                </div>
                            </div>
                </div>
...
<div id="training-wrapper">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" href="#collapse3">Nothing yet!!</a><br>
                          <a data-toggle="collapse" href="#collapse3">We will let you know soon...</a><br>
    ...
    background-color: #375584;
"><p>
  Stick with us, we will let you know soon.
</p></div>
        ...
        <div class="inner-wrapper">
            <div class="row">
                ...
                <a class="right carousel-control" href="#myCarousel1" data-slide="next">
                   ...
                   <br>
                   <style>
                       #stud>p,h3,label,option
                       {
                         color: black;
                       }
                   </style>
                   <div class="row">
                    <div class="col-md-4" id="stud">
                      <h3>STUDY MEDICINE</h3>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <p style="color: black; ">*File name shouldn't contain space,MAX 2GB<p>
                    </div>
                    <input type="hidden" name="date" id="date" value="<?php  echo date("Y/m/d");?>">
                    <button type="submit" name="submit" class="btn btn-lg">Submit</button>
                </form>
        ...
        <div class="inner-wrapper">
            <div class="row">
                <div class="container">
                  ...
                  <h3 style="color: white">Make a difference by your way</h3>
                     ...
                     <div class="panel-group" id="accordion">
                        ...
                        foreach($careers as $car)
                        {
                            ...
                            <div class="panel panel-default">
                              <div class="panel-heading">
                                <h4 class="panel-title">
                                  <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i?>"><h1 style="font-size: 20px;"><?php echo $car['left_heading'];?></h1><?php echo $car['left_date'];?></a>
                              </h4>
                          </div>
                          <div id="collapse<?php echo $i?>" class="panel-collapse collapse">
                            <div class="panel-body"><h3 style="color: white; font-size: 18px;"><?php echo $car['right_heading'];?></h3><p><?php echo $car['right_content'];?></p></div>
                        </div>
                    </div>
                    <?php
                    $i++;
        ...
        <div class="col-md-5">
            <div class="row">
                <form id="career_form" method="post" enctype="multipart">
                  ...
                  <div class="form-group">
                      <label for="pwd" style="color: white">Position applying for:</label>
                      <input type="text" class="form-control" id="position" name="position"  required="">
                  </div>


                  <div class="form-group">
                    <label for="pwd" style="color: white">Description:</label>
                    <textarea name="description" id="description" style="width: 100%;"></textarea>
                </div>
...
<div id="contact-wrapper">
    <div id="contact">
        <div class="inner-wrapper">
            <div class="row">
                <div class="container">
                    <h2 style="font-size: 30px;"><span>Contact us</span> Now</h2>
                            ...
                            <div class="contact-info">
                                <ul>
                                    <li class="first">
                                        ...
                                        <p> P.O.Box:53031, Office No:M-03,<br>BLD No:p/343,Behind UAE Exchange,<br>Shabia-10,Mussafah,Abu Dhabi,UAE.</p>
                                    </li>
                                    <li class="second">
                ...
                <div class="modal-content" id="service_modal">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="myCarousel2" class="carousel slide" data-ride="carousel">
                          ...
                          <!-- Wrapper for slides -->
                          <div class="carousel-inner events">
                             <!--  <div class="item active">
