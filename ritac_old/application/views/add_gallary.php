                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         ...
                         <form id="add_gallary" method="post" enctype="multipart">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gal_name" name="gal_name">
                          </div>
                          <div class="form-group">
                            <label for="name">Enter date:</label>
                            <input type="date" class="form-control" id="gal_date" name="gal_date">
                          </div>
                          <div class="form-group">
                        ...
                        *File name shouldn't contain space
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gal_description" name="gal_description">
                          </div>
