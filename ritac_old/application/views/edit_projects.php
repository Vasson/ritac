                        ...
                        <div class="panel-body">
                         ...
                         <form id="add_services" method="post" enctype="multipart">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $projects['name'];?>">
                          </div>
                          <div class="form-group">
                            <label for="description">image:</label>
                            <img src="<?php echo base_url();?>/vendors/images/projects/<?php echo $projects['image'];?>">
                            <input type="file" name="userfile[]" multiple style="width: 100%;">
                        *File name shouldn't contain space
                          </div>
                          <div class="form-group">
                            <label for="icon">description:</label>
                            <input type="text" class="form-control" id="description" name="description" value="<?php echo $projects['description'];?>">
                          </div>
