...
<head>
    ...
    <link href="<?php echo base_url();?>vendors/public3/assets/css/font-awesome.css" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="<?php echo base_url();?>vendors/public3/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
...
float: right;
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="<?php  echo base_url()?>home/logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="<?php echo base_url();?>home/gallary"><i class="fa fa-dashboard fa-3x"></i> GALLERY</a>
                    </li>
                    <li>
    ...
    <script src="<?php echo base_url();?>vendors/public3/assets/js/jquery.metisMenu.js"></script>
     ...
     <!-- <script src="<?php echo base_url();?>vendors/public3/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="<?php echo base_url();?>vendors/public3/assets/js/morris/morris.js"></script> -->
      <!-- CUSTOM SCRIPTS -->
