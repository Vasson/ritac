                         ...
                         <form id="add_services" method="post">
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="left_heading" name="left_heading">
                          </div>

                           <div class="form-group">
                            <label for="name">Enter Inside Heading:</label>
                            <input type="text" class="form-control" id="right_heading" name="right_heading">
                          </div>

                           <div class="form-group">
                            <label for="name">Enter Inside Content:</label>
                            <input type="text" class="form-control" id="right_content" name="right_content">
                          </div>
