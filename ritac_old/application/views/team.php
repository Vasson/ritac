                                    ...
                                    <tbody>
                                      ...
                                      foreach($team as $team)
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $team['image'];?><img src="<?php echo base_url();?>/vendors/images/team/<?php echo $team['image'];?>"></td>
                                            <td class="center"><?php echo $team['designation'];?></td>
                                         
                                            <td> <a href="<?php echo base_url();?>home/add_team/<?php echo $team['id'];?>" class="btn btn-info btn-sm" value="">
