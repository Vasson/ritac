                        ...
                        <div class="panel-body">
                         ...
                         <form id="edit_gallary" method="post" enctype="multipart">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gal_name" name="gal_name" value="<?php echo $gal['name'];?>">
                          </div>
                          <div class="form-group">
                            <label for="name">Enter date:</label>
                            <input type="date" class="form-control" id="gal_date" name="gal_date" value="<?php echo $gal['date'];?>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="description">image:</label>
                             <img src="<?php echo base_url();?>/gallery/<?php echo $gal['image'];?>">
                            <input type="file" name="userfile[]"  multiple style="width: 100%;">
                        *File name shouldn't contain space
                          </div>
                          <div class="form-group">
                            <label for="icon">description:</label>
                            <input type="text" class="form-control" id="gal_description" name="gal_description" value="<?php echo $gal['description'];?>">
                          </div>
