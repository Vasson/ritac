            ...
            <div class="container">
                ...
                <div id="menu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="training"><a href="#training-wrapper">Training</a></li>
...
<div id="portfolio-wrapper">
    <div id="portfolio">
        <div class="inner-wrapper">
            <div class="row">
                <div class="container">
                    <h2>Check out our <span>Projects</span></h2>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div id="portfolio-container">
                                <ul id="portfolio-items">
                                    ...
                                    {
                                    ?>
                                    <li class="portfolio-item" data-toggle="modal" data-target="#projectModal">
                                        <div>
                                    <img class="img-responsive" src="<?php echo base_url();?>vendors/images/projects/<?php echo $projects['image'];?>" alt="" data-toggle="modal" data-target="#projectModal">
                                            ...
                                            <div class="portfolio-item-description">
                                                <div>
                                                    ...
                                                    <h1><?php echo $projects['name'];?></h1>

                                                    <p class="project-tag"><?php echo $projects['description'];?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
...
<div id="client-wrapper">
    <div id="client">
        <div class="inner-wrapper">
            <div class="row">
                <div class="container">
                    <h2>Check out our <span>Network</span></h2>

                    <div class="row">
                        <div id="clients">
                             <div class="col-md-6 col-sm-9 col-xs-12">
                                <span>IT ASSOCIATE PARTNER</span><br>
                              
                                <img src="<?php echo base_url();?>vendors/images/clients/thinkpalm.png" alt=""><br>
                                <label style="font-size: 25px;color: #377352; font-family: Georgia;">THINK PALM TECHNOLOGIES,<br>INFO PARK,<br>KOCHI,<br>KERALA, INDIA.</label>
                                
                            </div>
                               
                              <div class="col-md-6 col-sm-9 col-xs-12">
                                <span>EDUCATIONAL ASSOCIATE PARTNER</span><br>
                                <img src="<?php echo base_url();?>vendors/images/clients/almanarat.png" alt=""><br>
                                <label style="font-size: 25px;color: #377352; font-family: Georgia;">MANARAT ALMARIFA,<br>ABUDHABI,<br>UAE.</label>
                             </div>


                           <!--  <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/1.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/2.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/3.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/4.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/5.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/6.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/7.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/8.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/9.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/10.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/11.png" alt=""></a>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-4">
                                <a href="#"><img src="<?php echo base_url();?>vendors/images/clients/12.png" alt=""></a>
                            </div> -->
            ...
            <div class="row">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                              <form id="training_form" method="post" enctype="multipart">
                                <div class="form-group">
                                  <label for="name">Name:</label>
                              ...
                              <div class="form-group">
                                ...
                                <select name="course" id="course" style="width: 100%; background-color: transparent;">
                                    ...
                                    <option value="online_tution">ONLINE TUTIONS</option>
                ...
                <div class="col-md-4">
                  <h1>ORIENTATION TRAINING</h1>
                  <p>It is important to manage that early onset of emotional impact from the beginning to ensure a productive and gratifying work experience.Through RITAC's orientation programme we will help you build highly impactful on-boarding programs and processes that will set a very positive pace with your new hires.</p>

                  <h1>ONLINE TUITIONS</h1>
                  <p>RITAC's online tutuion is a web based application which enable students to get trained from qualified and certified tutors.</p>

                  <h1>PSYCHOMETRIC TESTS</h1>
                  <p>We provide psychometric tests like aptitude, personality development, skill development and many more brain challenging tests...</p>
              </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="contact-info">
                                <ul>
                                    ...
                                    <li class="second">
                                        <p><i class="fa fa-phone fa-2"></i>+97126710212,+971507809135</p>
                        ...
                        <div class="col-md-12">
                            <div class="message-box">
                                ...
                                <form id="mail_form" method="post" enctype="multipart">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="button" name="submit" class="readmore send-button"
                                                   value="Send Message" onclick="save_details()">
                                        </div>
                                    </div>
                                </form>
                            </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5a4cc9a94b401e45400bda69/default';
s1.charset='UTF-8';
